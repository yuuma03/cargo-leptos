...
fn test_project_dev() {
    ...
    let cargo = build_cargo_server_cmd("build", &conf.projects[0], &mut command);
    ...
    let mut command = Command::new("cargo");
    let cargo = build_cargo_front_cmd("build", true, &conf.projects[0], &mut command);
...
fn test_workspace_project2() {
    ...
    let mut command = Command::new("cargo");
    let cargo = build_cargo_server_cmd("build", &conf.projects[1], &mut command);
    ...
    let mut command = Command::new("cargo");
    let cargo = build_cargo_front_cmd("build", true, &conf.projects[1], &mut command);
